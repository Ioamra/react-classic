  ...
  const handleBlur = (name: string) => {
    ...
    if (state === "login") {
      ...
      setForgotPasswordEmailError({
        isInvalid: !validateEmail(forgotPasswordEmail),
        errorMessage: !validateEmail(forgotPasswordEmail) ? "Veuillez entrer une addresse email valide" : "",
      });
    }
  };
      ...
      <ModalContent>
        {state === "forgot-password" ? (
          ...
          <>
            ...
            <ModalBody>
              <Tabs fullWidth size="md" aria-label="Tabs form" selectedKey={state} onSelectionChange={(key) => setState(key as "login" | "register")}>
